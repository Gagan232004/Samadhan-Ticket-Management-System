...
function replaceFile(filePath) {
  ...
  content = content.replace(/text-slate-900\/20/g, 'text-white/20'); // rollback specific translucent
  
  // Colored text on dark bg -> slightly darker for light bg
  ...
  // Restoring some button white text
...
const files = [
  ...
  'frontend/src/components/ticket-details/TicketDetail.tsx',
  'frontend/src/components/ticket-details/TicketDropdowns.tsx',
  'frontend/src/components/ticket-details/TicketHeader.tsx',
  'frontend/src/components/ticket-details/TicketReplyForm.tsx',
  'frontend/src/components/ticket-details/TicketThread.tsx',
  'frontend/src/components/ticket-details/SimilarTickets.tsx',
